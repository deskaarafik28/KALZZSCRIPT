--[[
    ...
    FIXED UI WITH TOGGLE BUTTON
    CLICK ICON POJOK KANAN BAWAH UNTUK BUKA MENU
--]]
...
local success, err = pcall(function()
    ...
    -- // ==========================================
    -- // CREATE TOGGLE BUTTON (POJOK KANAN BAWAH)
    -- // ==========================================
    local ToggleButton = Instance.new("TextButton")
    ToggleButton.Size = UDim2.new(0, 45, 0, 45)
    ToggleButton.Position = UDim2.new(1, -55, 1, -55)
    ToggleButton.Text = "⚡"
    ...
    ToggleButton.Parent = (CoreGui:FindFirstChild("RobloxGui") or LocalPlayer:WaitForChild("PlayerGui"))
    ...
    ToggleGlow.Image = "rbxassetid://6014261993"
    ToggleGlow.ImageColor3 = Color3.fromRGB(0, 255, 200)
    ...
    Gui.Name = "CyberAI_Menu"
    Gui.Parent = (CoreGui:FindFirstChild("RobloxGui") or LocalPlayer:WaitForChild("PlayerGui"))
    ...
    local function CreateToggle(page, text, default, callback)
        ...
        Btn.BackgroundColor3 = default and Color3.fromRGB(0, 200, 150) or Color3.fromRGB(70, 70, 80)
        ...
        ClickBtn.MouseButton1Click:Connect(function()
            toggled = not toggled
            Btn.BackgroundColor3 = toggled and Color3.fromRGB(0, 200, 150) or Color3.fromRGB(70, 70, 80)
    ...
    local function CreateSlider(page, text, min, max, default, callback, suffix)
        ...
        SliderFrame.Size = UDim2.new(1, 0, 0, 66)
    ...
    -- // INFO TAB
    -- // ==========================================
    CreateSection(TabContent["INFO"], "📋 SCRIPT INFO")
    CreateLabel(TabContent["INFO"], "CYBER-AI 2046 v3.0")
    CreateLabel(TabContent["INFO"], "Map: Violence District")
    CreateLabel(TabContent["INFO"], "Role: Survivor + Killer")
    
    CreateSection(TabContent["INFO"], "👨🏼‍💻 DEVELOPER")
    CreateLabel(TabContent["INFO"], "Created by: YUKI")
    CreateLabel(TabContent["INFO"], "Version: 3.0")
    CreateLabel(TabContent["INFO"], "Last Update: 2046")
    
    CreateSection(TabContent["INFO"], "⌨️ CONTROLS")
    CreateLabel(TabContent["INFO"], "Click ⚡ Button → Open Menu")
    CreateLabel(TabContent["INFO"], "Drag ⚡ Button → Move Button")
    CreateLabel(TabContent["INFO"], "Parry Key: F (Auto)")
    
    -- // ==========================================
    -- // MAIN TAB
    -- // ==========================================
    CreateSection(TabContent["MAIN"], "⚡ AUTO PARRY")
    CreateToggle(TabContent["MAIN"], "Auto Parry", false, function(v)
        Config.Main.AutoParry = v
    end)
    CreateSlider(TabContent["MAIN"], "Parry Range", 1, 30, 5.0, function(v)
        Config.Main.ParryRange = v
    end, " studs")
    
    CreateSection(TabContent["MAIN"], "🌙 MOONWALK")
    CreateToggle(TabContent["MAIN"], "Moonwalk", false, function(v)
        Config.Main.Moonwalk = v
    end)
    CreateLabel(TabContent["MAIN"], "Auto walk mundur saat gerak")
    
    CreateSection(TabContent["MAIN"], "⚙️ OPTIMAL MODE")
    CreateToggle(TabContent["MAIN"], "Optimal Mode", false, function(v)
        Config.Main.Optimal = v
    end)
    CreateLabel(TabContent["MAIN"], "Optimalkan semua fitur 100%")
    
    -- // ==========================================
    -- // ESP TAB
    -- // ==========================================
    CreateSection(TabContent["ESP"], "👤 ESP PLAYER")
    CreateToggle(TabContent["ESP"], "ESP Player", false, function(v)
        Config.ESP.PlayerESP = v
    end)
    CreateColorPicker(TabContent["ESP"], "Player Color", Config.ESP.PlayerColor, function(c)
        Config.ESP.PlayerColor = c
    end)
    
    CreateSection(TabContent["ESP"], "💀 ESP KILLER (MERAH)")
    CreateToggle(TabContent["ESP"], "ESP Killer", false, function(v)
        Config.ESP.KillerESP = v
    end)
    CreateLabel(TabContent["ESP"], "Killer only visible in RED")
    
    CreateSection(TabContent["ESP"], "⚡ ESP GENERATOR")
    CreateToggle(TabContent["ESP"], "ESP Generator", false, function(v)
        Config.ESP.GeneratorESP = v
    end)
    CreateColorPicker(TabContent["ESP"], "Generator Color", Config.ESP.GeneratorColor, function(c)
    ...
    -- // SURVI TAB
    -- // ==========================================
    CreateSection(TabContent["SURVI"], "🔧 AUTO GENERATOR")
    CreateToggle(TabContent["SURVI"], "Auto Generator", false, function(v)
        Config.Survival.AutoGenerator = v
    end)
    CreateDropdown(TabContent["SURVI"], "Method", {"Instant", "Normal", "Perfect"}, "Instant", function(v)
        Config.Survival.GenMethod = v
    end)
    CreateLabel(TabContent["SURVI"], "Instant: Langsung selesai")
    CreateLabel(TabContent["SURVI"], "Perfect: Skill check sempurna")
    
    -- // ==========================================
    -- // DEV TAB
    -- // ==========================================
    CreateSection(TabContent["DEV"], "💻 DEVELOPER")
    CreateLabel(TabContent["DEV"], "Creator: YUKI")
    CreateLabel(TabContent["DEV"], "UI: Custom Framework")
    CreateLabel(TabContent["DEV"], "Engine: Luau / Roblox")
    
    CreateSection(TabContent["DEV"], "🔧 TECHNICAL")
    CreateLabel(TabContent["DEV"], "✓ Optimized Code")
    CreateLabel(TabContent["DEV"], "✓ Low Memory Usage")
    CreateLabel(TabContent["DEV"], "✓ Fast Execution")
    CreateLabel(TabContent["DEV"], "✓ No Lag")
    
    CreateSection(TabContent["DEV"], "📦 VERSION")
    CreateLabel(TabContent["DEV"], "v3.0 - Clean UI")
    CreateLabel(TabContent["DEV"], "v3.0 - Toggle Button")
    CreateLabel(TabContent["DEV"], "v3.0 - Color Picker")
    ...
    ToggleButton.MouseButton1Click:Connect(function()
        ...
        if Main.Visible then
            ...
            local tween = TweenService:Create(Main, TweenInfo.new(0.2, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
    ...
    print("⚡ CYBER-AI 2046 v3.0 LOADED SUCCESSFULLY")
    print("👨🏼‍💻 BY YUKI")
    print("📌 CLICK ⚡ BUTTON TO OPEN MENU")
end)

if not success then
    warn("CYBER-AI ERROR: " .. tostring(err))
    print("⚠️ SCRIPT ERROR - PLEASE REJOIN OR USE COMPATIBLE EXECUTOR")
end
